...
- [Power-Up Optimizer](feature_power_up_optimizer.md) — powerUp.ts cost table/ladder/optimizer; found+documented a spec arithmetic discrepancy (verified via code, not forced); stray-node-process OOM gotcha for this environment's test hook
